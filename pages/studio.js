...
<<<<<<< HEAD
                    <div className='lg:w-[200px] w-full flex flex-col justify-between mb-3'>
                      <h3 className='text-white font-SignifierRegular lg:text-[27px] md:text-[24px] lg:block hidden'> Javier <br></br>Campos</h3>
                      <h3 className='text-white font-SignifierRegular lg:text-[27px] md:text-[24px] lg:hidden block'> Javier Campos</h3>
...
>>>>>>> 5854d5db40f88c8e6ea7dd1b5365a93baa24e06c
                    </div>
                  </div>
                </div>
              </div>
...
<<<<<<< HEAD
        <div className='lg:w-[805px] md:w-[754px] w-full'>
          <h2 className='font-FoundersGroteskMedium lg:text-4xl md:text-[31px] text-lg'>Past Collaborators</h2>
          <p className='font-SignifierRegular lg:text-xl md:text-xl text-base'>Regan Appleton, Romain Bael, Jacquelyn Bortolussi, Tom Chung, Sarah Cree,
            Jessie Croll, Paul Crowley, Alix Demontrond, Hande Ersoy, Adrien Fera, Mike Fugeta, Ashley Gesner, Matias T. Grez,  Maria Herrera, Paul Holley, Manuela Hurtavo,
            Arnold Jung, Zaid Kadhim, Nelly Lachman, Mario Lambraño, Michael Lis, Michael Lis, Colin Mbugua, Laura McMurran, David Morar, Juan David Moreno, Kate Richard,
            Clara Sabel, Jan Stretzlig, Bardia Tajik, Alex Vanderlee, Yiming Wang, Yanlan Wang, Britney Yan, Thomas Yuan, David Zeiben, Loriane Wong</p>
=======
        <div className="lg:w-[805px] md:w-[754px] w-full">
