    ...
    <div className={`${open ? 'block' : 'hidden'}`}>
      <div className="border-b-2 border-black">
        <p className="font-FoundersGroteskRegular lg:text-[23px] md:text-[22px] text-lg text-left mb-4">
          ...
          system. The program elements are organized in a linear fashion across
          the sloping site in response to the orientation sun, direction of
          local prevailing breezes. The double line of panels was then shifted
          and laterally accommodate views, maximize ventilation, and protect
          against solar gain.
        </p>
      ...
      <ul>
        ...
        <li className="border-b-2 border-black text-left py-2">
          ...
          <p className="font-FoundersGroteskRegular lg:text-[21px]">
            General Contractor: Boydco
          </p>
          <p className="font-FoundersGroteskRegular lg:text-[21px]">
            Project Photography: Ema Peter
          </p>
        </li>
      </ul>
    </div>
    ...
    <>
      ...
      <section className="custom-sec gallery-section">
        <figure className="relative gallery">
          <Image src={Gallery1} alt="gallery1"></Image>
        </figure>
        <figure className="relative gallery">
          <Image src={Gallery2} alt="gallery2"></Image>
        </figure>
        <figure className="relative gallery">
          <Image src={Gallery3} alt="gallery3"></Image>
        </figure>
        <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-1">
          ...
          <figure className="relative gallery">
            <Image src={Gallery5} alt="gallery5"></Image>
          </figure>
        </div>
        <figure className="relative gallery">
        ...
        <div className="lg:w-[899px] md:w-[683px] w-full mx-auto">
          <ul>
            <li className="font-FoundersGroteskMedium lg:text-[36px] md:text-[36px] text-[24px] mb-10">
              <Link href="#">
                <p className="flex items-center cursor-pointer lg:gap-10">
                  Baja homes that catch a wind
                  <Image src={Arrow} alt="Arrow"></Image>
                </p>
              </Link>
              <p className="font-FoundersGroteskRegular lg:text-lg md:text-lg text-xs">
                THE GLOBE AND MAIL
              </p>
            </li>
            <li className="font-FoundersGroteskMedium lg:text-[36px] md:text-[36px] text-[24px] mb-10">
            ...
            <li className="font-FoundersGroteskMedium lg:text-[36px] md:text-[36px] text-[24px] mb-10">
              <Link href="#">
                <p className="flex items-center cursor-pointer lg:gap-10">
                  Off-Grid in Z-Town<Image src={Arrow} alt="Arrow"></Image>
                </p>
              </Link>
              <p className="font-FoundersGroteskRegular lg:text-lg md:text-lg text-xs">
                CANADIAN ARCHITECT
      ...
      <section className="custom-sec mt-0">
        ...
        <WorkBox
          title="Hasting Sunrise Studio"
          image_path="/images/project14.png"
        />
        ...
        <WorkBox
          title="Grandview Renovation"
          image_path="/images/project17.png"
        />
      </section>
    </>
  );
