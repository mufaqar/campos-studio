            ...
            <div className={`absolute hidden left-[9px] right-[9px] grid lg:grid-cols-5 grid-cols-4 gap-2 }`}>
                ...
                <div className='float-right lg:col-span-4 col-span-3 bg-black'>
                    <div className='flex p-3 lg:pt-8 lg:pb-6 lg:px-5 lg:flex-row md:flex-col'>
                        ...
                        <div className='lg:w-[535px] w-full'>
