...
function AudioPlayer({ audioURL }) {
  ...
  // String
  const url =
    'https://www.mfiles.co.uk/mp3-downloads/massenet-thais-meditation-violin-piano.mp3';
  //String(`${audioURL}`)

  function unmute(context) {
    // for ios playing when users lock their screen
  ...
  return (
    <>
      <div className="flex items-center justify-center mt-[21px]">
        ...
        <div className="progress campo_bodyfont2 font-FoundersGroteskRegular">
          {' '}
          {result}{' '}
        </div>
      </div>
      <div className="mb-[21px]">
        ...
        <div className="flex items-center controls">
          <div
            className="mr-8 cursor-pointer md:mr-20 lg:mr-40 contoll-btn"
            onClick={handlePlayPause}
          >
            {!playing ? <BiPlay /> : <AiOutlinePause />}
          </div>
